...
* **商品詳細ページ（購入商品選択・お気に入り追加）**
  - 画像スライダーによる商品画像の複数表示、閲覧
  - 商品のカートへの追加
  - お気に入りへ追加時、既に登録済みのものは、アラートでお知らせする機能、重複追加させない機能
...
* **購入商品カート**
  ...
  - カートに商品が入っていない時は「レジへ進む」ボタンを非表示（からの決済を防ぐ制御）

* **お気に入りリスト**
  - 気になった商品を一覧ページに保管・削除
  - リストページから商品をカートへ入れて購入可能
  - お気に入りアイコンにバッチ表示（追加数を表示）
  - お気に入りに重複した商品を追加できない様に制御
